Model: Stochastic Activity Network with stochastic constraints (stoch_SAN)
========================================
...
large-scale projects. This problem has stochastic constraints on the amount of
flows to the specified nodes. The max flow to node i is constrained by some 
Given amount. 
...
* longest_path_to_all_nodes: a vector of longest length to each node in the graph
* constraints: compute the LHS of constraints, i.e. E[longest_path_to_node_i] - bound_i
...
Optimization Problem: Minimize Longest Path Plus Penalty (SAN-2)
================================================================
...
We require bounds on the expected longest path to some nodes, i.e. E[L_i] <= bounds_i
