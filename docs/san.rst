...
Optimization Problem 1: Minimize Longest Path Plus Penalty (SAN-1)
================================================================
...
Optimization Problem 2: Minimize Longest Path Plus Penalty with Stochastic Constraints (SAN-2)
================================================================
...
------------
We require that :math:`theta_i > 0` for each :math:`i`.
We allow :math:`n` constraints restricting the expected time to reach node :math:`i` of the form
:math:`E[T_i(\theta)] \leq a_i`
...
* length_to_node_constraint: Max expected length to corresponding constraint nodes
