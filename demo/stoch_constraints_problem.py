...
# -----------------------------------------------
from simopt.models.contam import ContaminationTotalCostDisc
fixed_factors = {"initial_solution": (1, 1, 1, 1, 1), "budget": 500}
myproblem =  ContaminationTotalCostDisc(fixed_factors=fixed_factors)
x = (1, 1, 1, 1, 1)
mysolution = Solution(x, myproblem)
# -----------------------------------------------
