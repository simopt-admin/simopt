...
def main():
    ...
    myproblem = OpenJacksonMinQueue(random=True, fixed_factors=fixed_factors, model_fixed_factors=model_fixed_factors)
    ...
    for i in range(n_inst):
        ...
        myproblem = OpenJacksonMinQueue(random=rand, fixed_factors=fixed_factors, random_rng=rng_list2, model_fixed_factors=model_fixed_factors)
