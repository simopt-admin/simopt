...
solver_factor_settings_filename = "astrodf_factor_setting"
...
crn_across_budget = False # Default
...
myDFMetaExperiment.run(n_macroreps=n_macroreps,  problem_name=problem_name, problem_fixed_factors=problem_fixed_factors, model_fixed_factors=model_fixed_factors  )
