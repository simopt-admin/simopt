...
model_fixed_factors = {}  # Override model factors

myproblem = SANLongestPathConstr(random=True, model_fixed_factors=model_fixed_factors)
...
for i in range(n_inst):
    ...
    myproblem = SANLongestPathConstr(random=rand, random_rng=rng_list2, model_fixed_factors=model_fixed_factors)
    ...
    myexperiment.run(n_macroreps=100)
    ...
    myexperiment.post_replicate(n_postreps=1) #200, 10
