...
print("here")
mymetaexperiment = MetaExperiment(solver_names=["RNDSRCH10", "RNDSRCH20", "RNDSRCH30", "RNDSRCH40", "RNDSRCH50"], problem_names=["CNTNEWS-1","FACSIZE-2", "RMITD-1", "SSCONT-1"], fixed_factors_filename="all_factors")
print("now here")
