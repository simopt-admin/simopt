...
from .models.trafficsignal import TrafficLight, MinWaitingTime
...
problem_directory = {
    ...
    "TRAFFICCONTROL-1": MinWaitingTime
}
...
problem_unabbreviated_directory = {
    ...
    "Min Waiting Time for Traffic Light": MinWaitingTime
}
model_directory = {
...
model_problem_unabbreviated_directory = {
    ...
    "Min Waiting Time for Traffic Light": "TrafficLight"
}
