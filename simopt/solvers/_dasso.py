...
def construct_df_from_random_matrix(
    ...
    """Construct a DataFrame from matrix x and factor_array.

    Both inputs are assumed to be numpy arrays.
...
def build_lhs(
    ...
    """Build a Latin Hypercube design dataframe.

    The dataframe is built from a dictionary of factor/level ranges.
