"""Nelder-Mead solver for simulation-optimization problems.
...
class NelderMead(Solver):
    ...
    def __init__(
        ...
        """Initialize Nelder-Mead solver with default values for factors."""
    ...
    def check_r(self) -> bool:
        """Check if number of replications is a positive integer."""
        return self.factors["r"] > 0

    def check_alpha(self) -> bool:
        """Check if reflection coefficient is a positive float."""
        return self.factors["alpha"] > 0

    def check_gammap(self) -> bool:
        """Check if expansion coefficient is a positive float."""
        return self.factors["gammap"] > 1

    def check_betap(self) -> bool:
        """Check if contraction coefficient is a positive float."""
        return (self.factors["betap"] > 0) & (self.factors["betap"] < 1)

    def check_delta(self) -> bool:
        """Check if shrink factor is a positive float."""
    ...
    def check_initial_spread(self) -> bool:
        """Check if initial spread is a positive float."""
    ...
    def check_const(self, pt: tuple, pt2: tuple) -> tuple:
        ...
        pt : tuple
            new point to check
        pt2 : tuple
            original point to check

        Returns:
        -------
        modified : tuple
            modified point based on bounds
