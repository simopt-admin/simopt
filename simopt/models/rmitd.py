...
Summary
-------
Simulate a multi-stage revenue management system with inter-temporal dependence. A detailed description of the problem can be found `here <https://simopt.readthedocs.io/en/latest/rmitd.html>`_.
"""
import numpy as np
