...
class IronOreMaxRev(Problem):
    ...
    base.Problem
    """
    def __init__(self, name: str = "IRONORE-1", fixed_factors: dict | None = None, model_fixed_factors: dict | None = None) -> None:
...
class IronOreMaxRevCnt(Problem):
    ...
    base.Problem
    """
    def __init__(self, name: str = "IRONORECONT-1", fixed_factors: dict | None = None, model_fixed_factors: dict | None = None) -> None:
        # Handle default arguments.
        if fixed_factors is None:
            fixed_factors = {}
        if model_fixed_factors is None:
