...
class SMFCVX(Model):
    ...
    def __init__(self, fixed_factors=None, random=False):
        ...
        self.specifications = {
            ...
            # "capacity_bound":{
            #     "description": "upper bound capacity function",
            #     "datatype": 'function',
            #     "default": self.default_upper_fn
            # },
            "mean_noise": {
    ...
    def default_upper_fn(self,rng,k = 5,lamb = 1):
        ...
        #the multiplier X (xX) is an Erlang ~ (k,lamb)
    ...
    def replicate(self, rng_list):
        ...
        #for i in range(len(noise)):
            #capacities.append(max(1000 * (self.factors["assigned_capacities"][i] - noise[i]), 0))
        #    capacities.append(self.default_upper_fn(self.factors["assigned_capacities"][i],exp_rng))
        capacities = self.default_upper_fn(exp_rng)
        #print("capacities: ", capacities)
        #print("assigned capacities: ", self.factors["assigned_capacities"])
...
class SMFCVX_Max(Problem):
    ...
    base.Problem
    """
    def __init__(self, name="SMFCVX-2", fixed_factors=None, model_fixed_factors=None, random=False, random_rng=None):
        if fixed_factors is None:
            fixed_factors = {}
        ...
        self.upper_bounds = (1000, ) * self.dim  #np.inf
    ...
    def attach_rngs(self, random_rng):
        ...
        if self.random:
            ...
            self.factors["cap"] = 1000*round(random_rng[0].random(),1)
