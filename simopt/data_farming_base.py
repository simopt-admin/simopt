...
class DesignPoint:
    ...
    def __init__(self, model: Model) -> None:
        """Initialize design point with model factors."""
        super().__init__()
    ...
    def attach_rngs(self, rng_list: MRG32k3a, copy: bool = True) -> None:
    ...
    def simulate(self, m: int = 1) -> None:
...
class DataFarmingExperiment:
    ...
    def __init__(
        ...
        """Initialize data-farming experiment with model and design points."""
...
class DataFarmingMetaExperiment:
    ...
    def __init__(
        ...
        solver_factor_headers: int | None = None,
        ...
        """Initialize data-farming meta experiment with problem-solver pairs and design points."""
        ...
        with open(self.csv_filename) as file:
            ...
            for row in reader:
                ...
                for factor in solver_factors_str:
                    datatype = self.solver_object.specifications[factor].get(
                        "datatype"
                    )
