...
myexperiment = Experiment(solver_name, problem_name, solver_fixed_factors={"sample_size": 200})
myexperiment.run(n_macroreps=10, crn_across_solns=True)
print("Here")
myexperiment.post_replicate(n_postreps=1000, n_postreps_init_opt=1000, crn_across_budget=True, crn_across_macroreps=False)
print("Now here.")
myexperiment.plot_progress_curves(plot_type="all", normalize=False)
