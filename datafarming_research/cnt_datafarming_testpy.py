...
def main():
    ...
    experiment = ProblemsSolvers(problem_factors = problem_factors[:16],
                                  solver_factors = solver_factors[:16],
                                  problem_names = problem_names[:16],
                                  solver_names = solver_names[:16],
                                  problem_renames = problem_renames[:16],
                                  solver_renames = solver_renames[:16])
