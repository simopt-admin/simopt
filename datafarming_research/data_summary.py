...
results_filename = './post_and_norm_same/same_postnorm_cnt_design_results_edited.csv' # file location of csv results for cross design of solver design & problem design
...
for prob_dp in range(prob_n_dp): # cycle through problem versions
    prob_df = exp_data.loc[exp_data['problem_dp'] == prob_dp, ['problem_dp', 'solver_dp', 'Final Relative Optimality Gap', 'gamma_1', 'gamma_2', 'eta_1', 'eta_2']]
    ...
    for sol_dp in range(sol_n_dp):
        ...
        avg_gaps.at[sol_dp, 'gamma_1'] = prob_df.loc[prob_df['solver_dp'] == sol_dp, 'gamma_1'].values[0]
        avg_gaps.at[sol_dp, 'gamma_2'] = prob_df.loc[prob_df['solver_dp'] == sol_dp, 'gamma_2'].values[0]
        avg_gaps.at[sol_dp, 'eta_1'] = prob_df.loc[prob_df['solver_dp'] == sol_dp, 'eta_1'].values[0]
        avg_gaps.at[sol_dp, 'eta_2'] = prob_df.loc[prob_df['solver_dp'] == sol_dp, 'eta_2'].values[0]
