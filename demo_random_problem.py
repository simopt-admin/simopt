...
model_fixed_factors = {"num_nodes": 9, "num_arcs": 14}  # Change to empty {} if want to use the default value 
...
for i in range(n_inst):
    ...
    x = (8,) * myproblem.dim  # Change the initial value according to the dimension
    mysolution = Solution(x, myproblem)
